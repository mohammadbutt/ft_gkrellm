...
/*   Updated: 2020/01/25 22:09:07 by mbutt            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::vector<std::string> OsInfoModule::updateOsInfoModule(void)
{
	std::vector<std::string> vectorString;
	vectorString.push_back(getUserName());
	vectorString.push_back(getSysName());
	vectorString.push_back(getNodeName());
	vectorString.push_back(getDarwinReleaseVersion());
	vectorString.push_back(getVersionDate());
	vectorString.push_back(getMachine());
	vectorString.push_back(getCpuInfo());
	vectorString.push_back(getMacOs());
	return(vectorString);
}
